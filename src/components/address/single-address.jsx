                    ...
                    <HStack space={4}>
                        ...
                        <Box flex={2.5}>
                            <HStack space={1} alignItems="center" mt={0}>
                                <FontAwesome color="#7F7F7F" size={16} name="location-arrow" />
                            ...
                            <Text fontWeight="500" fontSize="bd_xsm" mb={0} lineHeight="16px" color="bd_sec_text">
                                {address1}
                            </Text>
                        ...
                        {showDeleteIcon && <Pressable onPress={onAddressDeletePressed}>
