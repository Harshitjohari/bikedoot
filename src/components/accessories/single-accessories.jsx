...
const AccessoriesCard = ({ booking, onPress, showRemoveBtn = false, itemRemovedBtnPressed }) => {
                ...
                <HStack space={4}>
                    <Box flex={2}>
                        ...
                        <Box flex={2} alignItems="flex-end">
                            <Button p={0} onPress={showRemoveBtn && itemRemovedBtnPressed} mt={0} textStyle={{ fontSize: 12, fontWeight: "500" }} btnStyle={{ height: 30, padding: 0, borderRadius: 5, width: "40%", backgroundColor: showRemoveBtn ? "#C70000" : "#0da687" }}>{showRemoveBtn ? "Remove" : "Added"}</Button>
                        </Box>
