...
const AddOnScreen = (props) => {
  // console.log('props==============+>', props.route?.params?.booking?.service)
  ...
  const handleServiceCardPress = (_id) => {
    ...
    if (selectedServiceCards.includes(_id)) {
      setSelectedServiceCards(selectedServiceCards.filter((id) => id !== _id));
    } else {
      setSelectedServiceCards([...selectedServiceCards, _id]);
    }
  };
