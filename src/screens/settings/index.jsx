...
import { Pressable, Linking ,Image, ScrollView} from 'react-native';
...
//   { label: 'Terms & Conditions', icon: 'file-contract', route: Constant.TERMS_CONDITION_URL, isRoute: false },
//   { label: 'Privacy Policy', icon: 'lock', route: Constant.PRIVACY_POLICY_URL, isRoute: false },
//   { label: 'Help & Support', icon: 'whatsapp', route: `https://wa.me/916207627817?text=Hello BikedooT! I need your assistance.`, isRoute: false },
//   // { label: 'Help & Support', icon: 'whatsapp', route: `https://wa.me/916207627817?text=Hello Hello BikedooT! My name is :${userData?.name} and Registered Mobile No. is : ${userData?.mobile}. I need an assistance.`, isRoute: false }
// ];
